function Footer() {
  return (
    <div className=" grid w-full grid-cols-5 bg-black px-14 py-14 text-sm text-slate-100">
      <div className="col-span-1 space-y-2">
        <h3>Shop</h3>
        <ul className=" space-y-1  text-slate-50/60">
          <li>Man</li>
          <li>Woman</li>
          <li>Kids</li>
        </ul>
      ...
      <div className="col-span-1 space-y-1 text-center">
        <h3>Connect</h3>
        <ul>
          <p className="  text-slate-50/60"> helloSophia@gmai.com</p>
        </ul>
        <svg
          className=" pt-2"
          width="230"
